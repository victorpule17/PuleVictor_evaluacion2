...
public static b4a.example.b4xpages _b4xpages = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XPages",Debug.moduleToString(b4a.example.b4xpages.class),"Main",Debug.moduleToString(b4a.example.main.class),"Servidor",Debug.moduleToString(b4a.example.servidor.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}